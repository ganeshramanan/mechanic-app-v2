...
function App() {
  ...
  if (currentPage === "vehicles") {
    return <Vehicles onBack={() => setCurrentPage("dashboard")} />;
  }
  ...
  if (currentPage === "vehicle-history") {
    return <VehicleHistory onBack={() => setCurrentPage("dashboard")} />;
  }

  //Customers
  if (currentPage === "customers") {
    return <Customers onBack={() => setCurrentPage("dashboard")} />;
  }
          ...
          <div className="flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h2 className="text-lg font-bold sm:text-xl"></h2>
              </div>
            </div>
        ...
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <StatCard
              ...
              value={loadingStats ? "..." : dashboardStats.total_vehicles}
            ...
            <StatCard
              ...
              value={loadingStats ? "..." : dashboardStats.services_today}
            ...
            <StatCard
              title="Due Soon"
              value={loadingStats ? "..." : dashboardStats.due_soon}
              change="Next 7 days"
              icon={CalendarClock}
            />
            ...
            <StatCard
              ...
              value={
                loadingStats
                  ? "..."
                  : `₹${Number(dashboardStats.revenue || 0).toLocaleString(
                      "en-IN",
                    )}`
              }
              change="This month"
